        ...
        <tbody>
            <?php foreach ($instructores as $filaTemporal) { ?>
                <tr>
                    ...
                    <th><?php echo $filaTemporal->id_ins; ?></th>
                    ...
                    <td class="text-center">
                        ...
                        <a href="<?php echo site_url("Instructores/Eliminar/$filaTemporal->id_ins") ?>" title="Ediatar instructores"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16" style="color: red;">
