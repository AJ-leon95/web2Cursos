<center>
    ...
    <div class="row">
        <div class="col-8">Listado de Instructores</div>
        <div class="col-4">
            ...
            <?php foreach ($instructores as $filaTemporal) { ?>
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="<?php echo site_url("Instructores/Eliminar/$filaTemporal->id_ins") ?>" title="Ediatar instructores" onclick="return confirm('Estas seguro');" style="color: red;">
